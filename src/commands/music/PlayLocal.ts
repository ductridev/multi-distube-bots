import { ApplicationCommandOptionType, Attachment, ChatInputCommandInteraction } from "discord.js";
...
export default class PlayLocal extends Command {
  ...
  public async run(client: Lavamusic, ctx: Context): Promise<any> {
    const attachment = ctx.isInteraction
      ? ((ctx.interaction! as ChatInputCommandInteraction).options.get("file")?.attachment as Attachment)
