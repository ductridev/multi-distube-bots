...
interface LineActivityWeekdaysBySecondsProps {
...
export function LineActivityWeekdaysBySeconds({ data, loading }: LineActivityWeekdaysBySecondsProps) {
  if (loading) {
    return (
      <div className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm">
        <h3 className="text-sm font-medium text-gray-600 mb-4">
          Total listening time by weekday (seconds)
        </h3>
        <ChartSkeleton />
      </div>
    );
